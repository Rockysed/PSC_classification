# -*- coding: utf-8 -*-
"""
Created on Wed Jan 30 09:34:43 2019
    ...
    if htang[i] >=15 and htang[i] <=30:
     if ci_idx >= 0.5 and ci_idx <= 4.5:
         if ct <1000:
            ...
            if rad_app.shape[0] > 0:
            #save to file, has to be CORRECTED! ! !
                new_file = h5py.File("../data/csdb_blabeled_reinhold_features/csdb_radius_gaussnoise_complete_" + str(cont) + ".h5", "w")
